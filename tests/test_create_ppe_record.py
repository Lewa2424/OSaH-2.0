...
class CreatePpeRecordTests(unittest.TestCase):
    ...
    def test_create_ppe_record_persists_record_and_updates_notifications(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            create_ppe_record(database_path=context.database_path, employee_personnel_number='0001', ppe_name='Каска', is_required=True, is_issued=True, issue_date_text='2026-04-10', replacement_date_text='2026-05-10', quantity_text='1', note_text='Початкова видача', access_role=AccessRole.INSPECTOR)
