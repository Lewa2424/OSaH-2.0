...
class CancelWorkPermitRecordTests(unittest.TestCase):
    ...
    def test_cancel_work_permit_record_marks_record_and_writes_audit_log(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            create_work_permit_record(context.database_path, 'ND-UT-301', 'Вогневі роботи', 'Дільниця В', '2099-04-10 08:00', '2099-04-10 12:00', 'Майстер', 'Інспектор', '0001', 'executor', 'Потребує скасування', access_role=AccessRole.INSPECTOR)
            ...
            cancel_work_permit_record(context.database_path, int(created_record.record_id), 'Роботи перенесено', access_role=AccessRole.INSPECTOR)
