    ...
    def test_create_training_records_batch_creates_records_for_each_employee(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            try:
                ...
                for training_type, event_date_text, note_text in (
                    ("introductory", "2026-04-01", "Вступний масовий запис"),
                    ("primary", "2026-04-02", "Первинний масовий запис"),
                ):
            ...
            try:
                with self.assertRaisesRegex(ValueError, "послідовність інструктажів"):
                    create_training_records_batch(
                        ...
                        work_risk_category="high_risk",
                        conducted_by="Інспектор з ОП",
                        note_text="Помилковий масовий запис",
                    )
            finally:
                shut_down_logging()
