...
class SuggestFollowupWorkPermitNumberTests(unittest.TestCase):
    ...
    def test_suggest_followup_work_permit_number_returns_first_free_suffix(self) -> None:
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            create_work_permit_record(context.database_path, 'ND-BASE-001', 'Вогневі роботи', 'Дільниця А', '2099-04-10 08:00', '2099-04-20 18:00', 'Майстер', '', '', '', 'Базовий наряд', access_role=AccessRole.INSPECTOR)
            create_work_permit_record(context.database_path, 'ND-BASE-001-R1', 'Вогневі роботи', 'Дільниця А', '2099-04-10 08:00', '2099-04-20 18:00', 'Майстер', '', '', '', 'Похідний наряд', access_role=AccessRole.INSPECTOR)
