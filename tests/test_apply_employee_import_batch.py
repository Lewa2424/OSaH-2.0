...
class ApplyEmployeeImportBatchTests(unittest.TestCase):
    ...
    def test_apply_employee_import_batch_persists_new_employee(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            source_path.write_text(json.dumps([{'personnel_number': '0003', 'full_name': 'Петренко Марія Ігорівна', 'position_name': 'Майстер дільниці', 'department_name': 'Виробнича дільниця N2', 'employment_status': 'active'}], ensure_ascii=False), encoding='utf-8')
