    ...
    def test_extend_work_permit_record_updates_end_date_and_writes_audit_log(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            extend_work_permit_record(
                ...
                "2099-05-05 18:00",
                "Завершення робіт перенесено без зміни заходів безпеки",
            )
    ...
    def test_extend_work_permit_record_allows_extending_expired_record(self) -> None:
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            create_work_permit_record(
                ...
                "0001",
                "executor",
                "РџСЂРѕСЃС‚СЂРѕС‡РµРЅРёР№ РЅР°СЂСЏРґ",
            )
            ...
            extend_work_permit_record(
                ...
                int(created_record.record_id),
                "2000-05-01 18:00",
                "РџРѕС‚СЂС–Р±РЅРѕ РґРѕРєРѕРјРїР»РµРєС‚СѓРІР°С‚Рё СЂРѕР±РѕС‚Рё Р±РµР· Р·РјС–РЅРё Р·Р°С…РѕРґС–РІ",
            )
