...
class CreateMedicalRecordTests(unittest.TestCase):
    ...
    def test_create_medical_record_persists_record_with_computed_status(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            create_medical_record(database_path=context.database_path, employee_personnel_number='0001', valid_from_text='2026-04-10', valid_until_text='2099-04-10', medical_decision='fit', restriction_note='', access_role=AccessRole.INSPECTOR)
