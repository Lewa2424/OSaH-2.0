    ...
    def test_create_training_record_persists_record_and_updates_dashboard(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            try:
                ...
                self.assertTrue(any((training_record.employee_personnel_number == '0001' and training_record.next_control_date == '2026-10-10' and (training_record.note_text == 'Початковий запис') for training_record in training_records)))
        ...
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            try:
                with self.assertRaisesRegex(ValueError, 'послідовність інструктажів'):
                    create_training_record(database_path=context.database_path, employee_personnel_number='0001', training_type='repeated', event_date_text='2026-04-10', next_control_date_text='', work_risk_category='regular', conducted_by='Інспектор з ОП', note_text='Помилковий повторний', access_role=AccessRole.INSPECTOR)
            finally:
                shut_down_logging()
