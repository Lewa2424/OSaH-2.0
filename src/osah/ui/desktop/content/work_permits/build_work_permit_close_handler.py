...
def build_work_permit_close_handler(database_path: str, selected_record_var: StringVar, on_success: Callable[[], None]) -> Callable[[], None]:
    ...
    def close_selected_work_permit_record() -> None:
        ...
        if record_id is None:
            ...
            return
        try:
            close_work_permit_record(database_path, record_id, access_role=AccessRole.INSPECTOR)
