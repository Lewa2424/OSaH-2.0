...
def build_mark_news_item_as_read_handler(database_path: Path, selected_news_item_var: StringVar, on_success: Callable[[], None]) -> Callable[[], None]:
    ...
    def mark_selected_news_item_as_read() -> None:
        ...
        try:
            ...
            return
        mark_news_item_as_read(database_path, item_id, access_role=AccessRole.INSPECTOR)
