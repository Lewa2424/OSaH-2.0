...
def build_create_news_source_handler(database_path: Path, source_name_var: StringVar, source_url_var: StringVar, source_kind_var: StringVar, on_success: Callable[[], None]) -> Callable[[], None]:
    ...
    def save_news_source() -> None:
        ...
        """
        try:
            create_news_source(database_path=database_path, source_name=source_name_var.get(), source_url=source_url_var.get(), source_kind=NewsSourceKind(source_kind_var.get()), access_role=AccessRole.INSPECTOR)
