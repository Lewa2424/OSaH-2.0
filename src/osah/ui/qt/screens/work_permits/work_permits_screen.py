...
class WorkPermitsScreen(QWidget):
    ...
    def __init__(
        ...
        self._section_header = SectionHeader(
            "Наряди-допуски",
            "Список нарядів зліва. Оберіть рядок — праворуч відкриється картка: бригада, інструктаж, збереження.",
        )
        ...
        self.details_pane = WorkPermitDetailsPane(database_path, workspace.employees, access_role)
