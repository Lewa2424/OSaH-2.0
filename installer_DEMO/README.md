...
|--|--------------|-------------------|
| Файл | `ClearWork-Setup-1.1.3.exe` | `ClearWork-Demo-Setup-1.1.3.exe` |
...
Результат: `installer_DEMO\ClearWork-Demo-Setup-1.1.3.exe`
...
Передавайте лише `ClearWork-Demo-Setup-1.1.3.exe`. Попередьте, що після 48 годин потрібна повна версія з ключем установки.
